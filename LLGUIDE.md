# LOVER'S LAB LIST OF MODS TO DOWNLOAD
...
Comments: Basically an expansion of _SexLab Solutions,_ where certain quests have NSFW options. None of the creature content is supported, so disable it in the MCM or you may get bugs.
...
Comments: Allows you to have dialog sex with NPCs and random orgies on certain events. Configurable. Tends to place you in the female role whether you want to be or not. I'm not going to answer questions about that one. If you want to be a male you're kinda playing the wrong profile for it.
...
URL: https://www.loverslab.com/files/file/5482-sexlab-aroused-redux-sse-version-29/

File: `SexLabArousedSSELoose-29.7z`
