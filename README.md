...
**_Licentia MAX_ requires a different configuration from _Licentia BLACK._** If you are playing one of the alternate profiles in _Licentia MAX_, ignore the below paragraphs (until "Final Notes") and instead read this.
