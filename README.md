...
**_Licentia PITCH_** and **Licentia DEAD_** _require very specific, more complex configurations. If you are playing one of these profiles in _Licentia MAX_, ignore the below paragraphs (until "Final Notes") and instead read this.
