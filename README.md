...
- **LICENTIA SLOOT:** This version of Licentia features skimpy outfits for most females in the game, as well as custom overpowered sexy armors that can be found only randomly, piece by piece, in the "boss chests" of dungeons. Signature mods include 
